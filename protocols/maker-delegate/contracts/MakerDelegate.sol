...
/**
  * @title MakerDelegate: Deployable Trading Rules for the Swap Protocol
  * @notice Supports fungible tokens (ERC-20)
  * @dev inherits IMakerDelegate, Ownable uses SafeMath library
  */
contract MakerDelegate is IMakerDelegate, Ownable {
  ...
  constructor(
    ...
    address _makerDelegateContractOwner
  ) public {
  ...
  /**
    ...
    * @param _maxTakerAmount uint256 The maximum amount of ERC-20 token the maker-delegate would send
  ...
  /**
    * @notice Get a Maker-Side Quote from the MakerDelegate
    * @param _takerParam uint256 The amount of ERC-20 token the maker-delegate would send
    * @param _takerToken address The address of an ERC-20 token the maker-delegate would send
    * @param _makerToken address The address of an ERC-20 token the consumer would send
  ...
  /**
    * @notice Get a Taker-Side Quote from the MakerDelegate
    * @param _makerParam uint256 The amount of ERC-20 token the consumer would send
    * @param _makerToken address The address of an ERC-20 token the consumer would send
    * @param _takerToken address The address of an ERC-20 token the maker-delegate would send
    * @return uint256 takerParam The amount of ERC-20 token the maker-delegate would send
    */
  ...
  /**
    * @notice Get a Maximum Quote from the MakerDelegate
    * @param _takerToken address The address of an ERC-20 token the maker-delegate would send
    * @param _makerToken address The address of an ERC-20 token the consumer would send
    * @return uint256 takerParam The amount the maker-delegate would send
